...
Public Class ColumnSort : Implements IComparer
    ...
    End Sub
    Private Function CompareInt(ByVal x As Single, ByVal y As Single) As Integer
        If x > y Then
            Return 1
        ElseIf x < y Then
            Return -1
    ...
    Public Function Compare(ByVal a As Object, ByVal b As Object) As Integer Implements IComparer.Compare
        ...
        Dim xInt As Single, yInt As Single

        If bAscending Then
            If Single.TryParse(xText, xInt) AndAlso Single.TryParse(yText, yInt) Then
