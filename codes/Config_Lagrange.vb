...
Public Class Config_Lagrange
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        muti_threads_DEC = NumericUpDown1.Value
        If File.Exists(root_path + "temp\lg_err.txt") Then
            File.Delete(root_path + "temp\lg_err.txt")
        End If
        If File.Exists(root_path + "temp\lg_result.txt") Then
            File.Delete(root_path + "temp\lg_result.txt")
        End If
        DeleteFiles(root_path + "temp", ".DEC.txt")
        DeleteFiles(root_path + "temp", ".dec")
        DeleteFiles(root_path + "temp", ".end")
        DeleteFiles(root_path + "temp", ".data")
        DeleteFiles(root_path + "temp", ".rm")
        ...
        For i As Integer = 0 To ListBox2.Items.Count - 1
            excluded_ranges += Distributiton_to_Binary(ListBox2.Items(i), RangeStr.Length) + " "
        Next
        ...
        If CheckBox3.Checked Then
            ...
            For Each i As Char In RangeStr
                ...
                temp_range(UBound(temp_range)) = Distributiton_to_Binary(i.ToString, RangeStr.Length)
            Next
            For i As Integer = 0 To ListBox1.Items.Count - 1
                ReDim Preserve temp_range(temp_range.Length)
                temp_range(UBound(temp_range)) = Distributiton_to_Binary(ListBox1.Items(i), RangeStr.Length)
            Next

            For j As Integer = 0 To DataGridView5.Rows.Count - 1
                If Array.IndexOf(temp_range, Distributiton_to_Binary(DataGridView5.Rows(j).Cells(2).Value, RangeStr.Length)) = -1 Then
                    ReDim Preserve temp_range(temp_range.Length)
            ...
            Next
        Else
            include_ranges = NumericUpDown2.Value.ToString
        End If
        ...
        'Else
        '    base_rates = "{'dispersal': " + (Val(TextBox2.Text) + 4.0E-17).ToString + ", 'extinction': " + (Val(TextBox3.Text) + 1.0E-17).ToString + "}"
        'End If
        ...
        'lg_file = lg_file.Replace("#root_time#", root_time.ToString)
        lg_file = lg_file.Replace("#area_dispersal#", area_dispersal)
        lg_file = lg_file.Replace("#include_ranges#", include_ranges)
        lg_file = lg_file.Replace("#excluded_ranges#", excluded_ranges)
        If CheckBox3.Checked = False Then
            lg_file = lg_file.Replace("#excludedists", "excludedists")
        End If
        lg_file = lg_file.Replace("#area_labels#", area_labels)
        'lg_file = lg_file.Replace("#base_rates#", base_rates)
        lg_file = lg_file.Replace("#dispersal_durations#", dispersal_durations)
        'lg_file = lg_file.Replace("#lag_taxa#", lag_taxa)
        'lg_file = lg_file.Replace("#taxon_range_data#", taxon_range_data)
        'lg_file = lg_file.Replace("#lag_tree#", lag_tree)
        'lg_file = lg_file.Replace("#max_range_size#", NumericUpDown2.Value.ToString)
        lg_file = lg_file.Replace("#mrca#", mrca)
        If CheckBox2.Checked Then
            lg_file = lg_file.Replace("#estimate_dispersal_mask", "estimate_dispersal_mask")
        End If
        ...
        wr2.Close()
        Dim wr3 As New StreamWriter(root_path + "temp\final.rm", False, System.Text.Encoding.Default)
        wr3.Write(area_dispersal)
        wr3.Close()
        sdec_lg = lg_file
        lg_file = lg_file.Replace("#ratematrix#", root_path + "temp\final.rm")
        lg_file = lg_file.Replace("#treefile#", root_path + "temp\final.tre")
        lg_file = lg_file.Replace("#datafile#", root_path + "temp\final.data")
        Dim wr As New StreamWriter(root_path + "temp\final.lg", False)
        wr.Write(lg_file)
        wr.Close()
        If File.Exists(root_path + "temp\lg_result.txt") Then
            File.Delete(root_path + "temp\lg_result.txt")
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Me.Hide()
    End Sub
    Private Sub Lag_Config_VisibleChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.VisibleChanged
    ...
    Public Sub Read_Poly_Tree(ByVal Treeline As String)
        ...
        root_time = CSng(root_time.ToString("F3")) + 0.001
        config_tree_time = root_time
    ...
    Private Sub Lag_Config_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
       ...
       Dim opendialog As New SaveFileDialog
        ...
        If resultdialog = DialogResult.OK Then
            ...
            For i As Integer = 1 To time_period_num
                dispersal_durations += DataGridView3.Rows(i).Cells(0).Value + " "
            Next
            Dim wr3 As New StreamWriter(opendialog.FileName, False, System.Text.Encoding.Default)
            wr3.Write(area_dispersal)
    ...
    Private Sub Button10_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button10.Click
        ...
        If resultdialog = DialogResult.OK Then
            If File.Exists(opendialog.FileName) Then
                Dim sr As New StreamReader(opendialog.FileName, System.Text.Encoding.Default)
                ...
                If line.Split(" ").Length = RangeStr.Length Then
                    ...
                    If time_period_num <> temp_number / (RangeStr.Length) Then
                        ...
                        Exit Sub
                    End If
                    Dim sr1 As New StreamReader(opendialog.FileName, System.Text.Encoding.Default)
                    Dim Tempchar() As Char = RangeStr.ToUpper
                    Array.Sort(Tempchar)
                    Dim r As Integer
                    DataGridView3.AllowUserToAddRows = True
    ...
    Private Sub Button11_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button11.Click
        ...
        For i As Integer = 0 To Tempchar.Length - 1
            For j As Integer = 0 To Tempchar.Length - 1
                DataGridView2.Rows(i).Cells(j).Value = "1.0"
            Next
        Next
        DataGridView2.BackgroundColor = Color.LightGray
        DataGridView2.AllowUserToAddRows = False
